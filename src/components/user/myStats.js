...
class DataShower extends Component{
    ...
    getData(courseId, creatorId){

        axios.post('http://localhost:3000/tanya/user/' + creatorId)
    ...
    render(){
        ...
        return(<div><div>
            ...
            <p>creatorName {state.creatorName}</p>
            <h6>TestResults</h6>
...
class seeTestResults extends Component{
    constructor(props){
        ...
        axios.get('http://localhost:3000/tanya/course/courseisdone/user/' + localStorage.getItem("id"))
